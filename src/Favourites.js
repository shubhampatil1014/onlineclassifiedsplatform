...
export default function Favourites() {
    ...
    const addToFavourite = async (productId) => {
        try {
            const isAdded = await addToFavourites(productId);
            if (isAdded === "Y") {
                document.querySelector(`.favourite${productId}`).src = "images/liked.png";
            } else if (isAdded === "N") {
                document.querySelector(`.favourite${productId}`).src = "images/unliked.png";
            }
